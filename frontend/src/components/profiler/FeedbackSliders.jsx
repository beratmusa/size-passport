  ...
  return (
    <div className="space-y-4 bg-zinc-50 p-5 rounded-2xl border border-zinc-100 flex flex-col justify-center min-w-0">
          ...
          <div className="px-1">
            ...
            <div className="relative w-full flex justify-between mt-2 px-0">
                <div className="flex flex-col items-start w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-400 font-medium uppercase leading-tight whitespace-nowrap text-left">Too<br/>Small</span>
                </div>
                <div className="flex flex-col items-center w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-400 font-medium uppercase leading-tight whitespace-nowrap text-center">A Bit<br/>Small</span>
                </div>
                <div className="flex flex-col items-center w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-600 font-bold uppercase leading-tight whitespace-nowrap text-center">Perfect</span>
                </div>
                <div className="flex flex-col items-center w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-400 font-medium uppercase leading-tight whitespace-nowrap text-center">A Bit<br/>Big</span>
                </div>
                <div className="flex flex-col items-end w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-400 font-medium uppercase leading-tight whitespace-nowrap text-right">Too<br/>Big</span>
                </div>
            </div>
          </div>
      </div>
      ...
      <div className="space-y-3 pt-2">
          <div className="flex justify-between items-center gap-3">
            <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest leading-none">2. Size Preference?</label>
          ...
          <div className="px-1">
            ...
            <div className="relative w-full flex justify-between mt-2 px-0">
                <div className="flex flex-col items-start w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-400 font-medium uppercase leading-tight whitespace-nowrap text-left">Want<br/>Smaller</span>
                </div>
                <div className="flex flex-col items-center w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-800 font-bold uppercase leading-tight whitespace-nowrap text-center">Perfect</span>
                </div>
                <div className="flex flex-col items-end w-0 overflow-visible">
                    <span className="text-[9px] text-zinc-400 font-medium uppercase leading-tight whitespace-nowrap text-right">Want<br/>Bigger</span>
                </div>
            </div>
          </div>
      </div>
