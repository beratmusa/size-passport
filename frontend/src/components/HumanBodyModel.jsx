        ...
        <>
          ...
          <g filter="url(#thermal)" className="mix-blend-multiply opacity-70">
            ...
            <g className={`transition-all duration-700 ${results.arm?.status === 'No Data' ? 'opacity-0' : (activeZone && activeZone !== 'arm' ? 'opacity-5' : 'opacity-100')}`}>
              <line x1="108" y1="140" x2="85" y2="250" stroke={results.arm?.color || '#a1a1aa'} strokeWidth="12" strokeLinecap="round" />
              <line x1="192" y1="140" x2="215" y2="250" stroke={results.arm?.color || '#a1a1aa'} strokeWidth="12" strokeLinecap="round" />
            </g>
        ...
        <>
          ...
          <g filter="url(#thermal)" className="mix-blend-multiply opacity-70">
            ...
            <g className={`transition-all duration-700 ${results.inseam?.status === 'No Data' ? 'opacity-0' : (activeZone && activeZone !== 'inseam' ? 'opacity-5' : 'opacity-100')}`}>
               <line x1="145" y1="280" x2="115" y2="560" stroke={results.inseam?.color || '#a1a1aa'} strokeWidth="10" strokeLinecap="round" />
               <line x1="155" y1="280" x2="185" y2="560" stroke={results.inseam?.color || '#a1a1aa'} strokeWidth="10" strokeLinecap="round" />
            </g>
            <g className={`transition-all duration-700 ${results.outseam?.status === 'No Data' ? 'opacity-0' : (activeZone && activeZone !== 'outseam' ? 'opacity-5' : 'opacity-100')}`}>
               <line x1="100" y1="220" x2="85" y2="550" stroke={results.outseam?.color || '#a1a1aa'} strokeWidth="6" strokeLinecap="round" />
               <line x1="200" y1="220" x2="215" y2="550" stroke={results.outseam?.color || '#a1a1aa'} strokeWidth="6" strokeLinecap="round" />
            </g>
